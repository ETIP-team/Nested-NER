...
from _4_28_bilstm_attention_nested_connect.bilstm_attention_control_method_2_3 import AttentionNestedNERModel
from _4_28_bilstm_attention_nested_connect.control_config import Config
from _4_28_bilstm_attention_nested_connect.attention_neww2vmodel import geniaDataset

from _4_28_bilstm_attention_nested_connect.utils import data_prepare, output_summary, output_sent, output_level
from _4_28_bilstm_attention_nested_connect.utils import find_entities, find_entities_relax


def get_metrics_one_layer(config: Config, one_layer_metrics: list) -> pd.DataFrame:
    """

    :param one_layer_metrics: one nested level metrics
